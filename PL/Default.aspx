            ...
            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Supervisor">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="Label5" runat="server" Text='<%# Bind("Supervisor") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Tenure">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtTenure" runat="server" Text='<%# Bind("Tenure") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="Label5" runat="server" Text='<%# Bind("Tenure") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
