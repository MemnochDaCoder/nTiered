        ...
        <table style="width: 320px">
            ...
            <tr>
                <td>
                    Salary</td>
                <td id="lblSalary">
                    <asp:Label ID="lblSalary" runat="server" Font-Bold="True"></asp:Label></td>
            </tr>
            <tr>
                <td>
                    Department</td>
                <td>
                    <asp:Label ID="lblDept" runat="server" Font-Bold="True"></asp:Label></td>
            </tr>
            <tr>
                <td>
                    Supervisor</td>
                <td>
                    <asp:Label ID="lblSupervisor" runat="server" Font-Bold="True"></asp:Label></td>
            </tr>
            <tr>
                <td>
                    Tenure</td>
                <td>
                    <asp:Label ID="lblTenure" runat="server" Font-Bold="True"></asp:Label></td>
            </tr>
        </table>
